...
REM AWS_ELASTICACHE_HOME must be defined.
if defined AWS_ELASTICACHE_HOME (
    set SERVICE_HOME="%AWS_ELASTICACHE_HOME:"=%"
) else (
    goto AWS_ELASTICACHE_HOME_MISSING
)
